                ...
                <>
                    ...
                    >
                        <div className='overflow-x-auto'>
                            ...
                            <tbody>
                            {users.orders_customer && Array.isArray(users.orders_customer) &&
                              users.orders_customer.map((item: any) => (
                                <tr key={item.id} onClick={() => router.push(`/orders/orders-view/?id=${item.id}`)}>
                                    ...
                                    <td data-label="pickup_time">
                                        { dataFormatter.dateTimeFormatter(item.pickup_time) }
                                    </td>
                                    
                                    
                                    
                                    <td data-label="paid">
                                        { dataFormatter.booleanFormatter(item.paid) }
                                    </td>
                                    
                                    
                                    
                                    <td data-label="stripe_charge">
                                        { item.stripe_charge }
                                    </td>
                        ...
                        {!users?.orders_customer?.length && <div className={'text-center py-4'}>No data</div>}
                    </CardBox>
                </>
