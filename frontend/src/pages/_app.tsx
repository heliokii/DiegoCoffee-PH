...
function MyApp({ Component, pageProps }: AppPropsWithLayout) {
  ...
  const description = "Playful single-page site for Diego Coffee & Cocktail Studio with menu, bookings, admin, and event pitches."
  const url = "https://flatlogic.com/"
  const image = "https://project-screens.s3.amazonaws.com/screenshots/37967/app-hero-20260130-125207.png"
