...
const EditLocations = () => {
  ...
  useEffect(() => {
      if (typeof locations === 'object') {
          ...
          Object.keys(initVals).forEach(el => newInitialVal[el] = (locations)[el])
  ...
  return (
    <>
      ...
      <SectionMain>
        <SectionTitleLineWithButton icon={mdiChartTimelineVariant} title={'Edit locations'} main>
        {''}
