...
module.exports = class CategoriesDBApi {
    ...
    static async findBy(where, options) {
        ...
        output.menu_items_category = await categories.getMenu_items_category({
            transaction
        });
        ...
        output.icon = await categories.getIcon({
            transaction
        });
